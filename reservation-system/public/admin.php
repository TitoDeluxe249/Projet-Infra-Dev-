...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['flights'])) {
        ...
        $departure_city = $_POST['flight_departure_city'];
        ...
        $sql = "INSERT INTO $ (id, flight_number, departure_city, arrival_city, departure_time, arrival_time) VALUES (?, ?, ?, ?, ?, ?)";
        $sql = "INSERT INTO $ (nom, description, prix, image_url, category) VALUES (?, ?, ?, ?, ?)";
        ...
        echo "Le vol d'avion avec l'ID $product_id a été supprimé avec succès de l'aeroport LAS $selected_category.";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container mt-5">
        ...
        <form method="post" action="admin.php">
            ...
            <div class="form-group">
                <select name="selected_category" class="form-control" required>
                    <option value="Vol d'avion">Vol d'avion</option>
        ...
        <?php if (isset($_POST['choose_category'])) : ?>
            <form method="post" action="admin.php">
                <h4>Ajouter/Supprimer un vol d'avion</h4>
                <input type="hidden" name="selected_category" value="<?= $_POST['selected_category'] ?>">
                <div class="form-group">
                    <label for="product_name">Nom du vol :</label>
